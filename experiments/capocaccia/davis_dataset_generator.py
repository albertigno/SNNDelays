...
time = 13000 # recording time in ms (for some strange reason, wehave to set it twice the actual time)

time = 2000 # recording time in ms (for some strange reason, wehave to set it twice the actual time)
#time = 600000 # recording time in ms (for some strange reason, wehave to set it twice the actual time)
#time = 360000 # 3 minutes
time = 600000 # 5 minutes
delta_time = 20 # time interval in ms
