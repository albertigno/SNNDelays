...
data = np.load(os.path.join(DATASET_PATH, 'raw_datasets', 'Letters', 'ten_letter_classification_dataset.npz'))
...
dataset_dict["dataset_name"] = "10letters"
